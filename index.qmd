...
- **Visualise your data**! 
- See also: [the DataSaurus Dozen](https://blog.revolutionanalytics.com/2017/05/the-datasaurus-dozen.html)
![](images/DataSaurus Dozen.gif){.fragment .absolute top="400" left="10" width="650"}
