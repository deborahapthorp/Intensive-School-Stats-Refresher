---
title: "Fourth Year Stats Refresher 2026"
...
| [R/RStudio](https://posit.co/downloads/) | FREE, extremely powerful, makes AMAZING plots, best for reproducibility                          | Steep learning curve, sometimes not super easy to interpret output, need to Google a lot     |

## Statistics languages

![Image credit - Darren L. Dahly](images/SPSS_is_clown_car.png)
...
-   Really good blog post [here](https://www.teaguehenry.com/strings-not-factors/2021/2/21/eight-principles-of-good-data-management) about principles of data management
...
-   Poisson regression, ordinal logistic regression, negative binomial regression (all available in SPSS under the Generalized Linear Model menu, or in jamovi’s GAMLj3 add-on)
-   Bootstrapping is another possibility - available in SPSS and ALSO now in jamovi! 
...
-   Moderation is mathematically exactly the same thing as interaction in regression (just with some extra bootstrapping if you do it in Process)
